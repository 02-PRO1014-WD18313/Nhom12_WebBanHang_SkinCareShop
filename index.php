...
<body>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-2 d-lg-block d-none block-logo a-center">
                        <a href="/" class="logo">
                            <img src="img/logo1.jpg" alt="SonAuth Official">
                        </a>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-2 d-lg-flex header-right">
                        <div class="header-page-link">
                            <ul class="group-account">
                                ...
                                <li class="cart-drop">
                                    <div class="icon">
                                        <a href="javascript:;" class="nd-header-cart" aria-label="Xem giỏ hàng"
                                            title="Giỏ hàng">
                                    ...
                                    <nav class="header-nav">
                                        <ul class="item_big">
                                            ...
                                            <li class="nav-item   has-mega">
                                                <a class="a-img caret-down" href="#" title="SẢN PHẨM">SẢN PHẨM
                                                ...
                                                <i class="fa fa-caret-down d-block d-sm-block d-lg-none d-xl-none"aria-hidden="true"></i>
                                                 <div class="mega-content d-lg-block d-none">
                                                    <div class="level0-wrapper2 row">
                                                        <div class="col-xl-12 col-lg-12 col-12">
                                                            <div class="nav-width nav-block nav-block-center">
                                                                <ul class="level0 row">
                                                                    <li class="level1 parent item col-lg-3">
                                                                        <h2 class="h4">
                                                                            <a href="#"title="Làm sạch da">
                                                                                <span>Làm sạch da</span>
                                                                            </a>
                                                                        </h2>
                                                                        <ul class="level2">
                                                                            <li class="level2">
                                                                                <a href="#" title="Tẩy trang">
                                                                                    <span>Tẩy trang</span>
                                                                                </a>
                                                                            </li>
                                                                            <li class="level2">
                                                                                <a href="#" title="Sữa rửa mặt">
                                                                                    <span>Sữa rửa mặt</span>
                                                                                </a>
                                                                            </li>
                                                                            <li class="level2">
                                                                                <a href="#" title="Tẩy tế bào chết">
                                                                    ...
                                                                    <li class="level1 parent item col-lg-3">
                                                                        <h2 class="h4"><a href="#" title="Toner">
                                                                            <span>Toner</span></a>
                                                                        </h2>
                                                                    </li>
                                                                    <li class="level1 parent item col-lg-3">
                                                                        <h2 class="h4"><a href="#" title="Kem dưỡng ẩm">
                                                                            <span>Kem dưỡng ẩm</span>
                                                                            </a></h2>
                                                                    </li>
                                                                    <li class="level1 item col-lg-3">
                                                                        <h2 class="h4"><a href="#"
                                                                                title="Serum"><span>Serum</span></a>
                                                                        </h2>
                                                                    </li>
                                                                    <li class="level1 item col-lg-3">
                                                                        <h2 class="h4"><a href="#"
                                                                                title="Mặt nạ"><span>Mặt nạ</span></a>
                                                                        </h2>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <li class="nav-item ">
                                                <a class="a-img" href="#" title="BLOG">
                                                    GIỚI THIỆU
                                                </a>
                                            </li>
                                            <li class="nav-item ">
                                                <a class="a-img" href="#" title="VE CHUNG TOI">
                                                    LIÊN HỆ
                                                </a>
                                            </li>
                                            <li class="nav-item d-block d-sm-block d-md-block d-lg-none d-xl-none"><a
                                                    href="3" title="Đăng nhập">Đăng nhập</a>
                                            </li>
                                            <li class="nav-item d-block d-sm-block d-md-block d-lg-none d-xl-none"><a
                                                    href="#" title="Đăng ký">Đăng ký</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
    ...
    <section>
        <div class="slideshow-container">
            <div class="mySlider fade">
                <img src="img/slide_1_img.jpg">
                <div class="text"></div>
            </div>
            <div class="mySlider fade">
                <img src="img/slide_2_img.webp">
                <div class="text"></div>
            </div>
    ...
    <!--Product-->
    <section>
        <a href="#"><h2>TOP SẢN PHẨM BÁN CHẠY</h2></a>
        <div class="">
            <div>
    ...
    <section>
        <a href="#"><h2>TOP SẢN PHẨM KHUYẾN MÃI</h2></a>
        <div></div>
    </section>
    <section>
        <a href="#"><h2>TOP SẢN PHẨM ĐƯỢC YÊU THÍCH NHẤT</h2></a>
        <div></div>
    </section>
    <!--End product-->
    <footer>
        <div class="footer-container">
            <div class="row">
                ...
                <div class="content-footer">
                    <p>"Skin Care Shop - thương hiệu mỹ phẩm lành tính, dịu nhẹ"</p>
                </div>
            </div>
            <div class="address-footer">
                ...
                <div class="content-footer">
                    <p>
                        ...
                        <strong>Điện thoại:</strong> 0973732900 <br>
                        <strong>Email:</strong> skincare123@gmail.com
                    </p>
                </div>
            </div>
            <div class="">
            ...
            <div class="widget-footer">
                ...
                <div class="content-footer">
                    <ul class="footerNav-social">
                        <li><a href="#" target="_blank" rel="noopener" title="Facebook"
                                aria-label="Facebook"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="#" target="_blank" rel="noopener" title="Instagram"
                                aria-label="Instagram"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="#" target="_blank" rel="noopener" title="Google Plus" aria-label="Google Plus"><i

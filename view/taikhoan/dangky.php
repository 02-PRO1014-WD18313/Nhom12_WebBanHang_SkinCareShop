  ...
  <div class="signup-container">
    ...
    <form class="signup-form" action="index.php?act=dangky" method="post">
      <div class="form-group">
        ...
        <input type="text" name="user" required placeholder="VD: thuuyen54">
      </div>
      <div class="form-group">
        <label for="email">Email:</label>
        <input type="email" name="email" required placeholder="VD: thuuyen542004@gmail.com">
      </div>
      <div class="form-group">
        <label for="phone">Số điện thoại:</label>
        <input type="tel" name="tel" required placeholder="VD: 0564665042">
      </div>
      <div class="form-group">

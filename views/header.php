        ...
        <header class="header trans_300">
            ...
            <div class="top_nav">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="top_nav_left">MIỄN PHÍ GIAO HÀNG TRÊN TOÀN QUỐC KHI MUA 3 SẢN PHẨM !</div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-right">
                            <div class="logo_container">
                                <!-- <img src="views\images\skincareshop.png" alt=""> -->
                                <a href="#">Skincare<span>Shop</span></a>
                            </div>
                            <nav class="navbar">
                                <ul class="navbar_menu">
                                    <li><a href="index.php">Trang chủ</a></li>
                                    <li><a href="index.php?act=categories&iddm=40">Trang điểm</a></li>
                                    <li><a href="index.php?act=categories&iddm=34">Chăm sóc da</a></li>
                                    <li><a href="index.php?act=categories&iddm=33">Chăm sóc cơ thể</a></li>

...
<div class="main_slider" style="background-image:url(./views/images/sonauth.jpg)">
	...
	<div class="banner">
		<div class="container">
			<div class="row">
                ...
                <div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(./views/images/da.jpg)">
						...
						<div class="product-item men">
							<div class="product discount product_filter">
								<a href="index.php?act=ctsp&idsp=<?= $sp['id'] ?>" class="product_image">
									<img src="views/images/<?= $sp['img'] ?>" alt="" style="width: 90%; height:250px; ">
								</a>
								<div class="favorite favorite_left"></div>
								<div class="product_info">
									<h6 class="product_name"><a href="index.php?act=ctsp&idsp=<?= $sp['id'] ?>"><?= $sp['name'] ?></a></h6>
									<div class="product_price"><?= number_format($sp['price']) ?> K<span><?= number_format($sp['price']*110/100) ?> K</span></div>
								</div>
							</div>
